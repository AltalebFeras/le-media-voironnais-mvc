...
<head>
    ...
    <style>
        ...
        .tete { background: linear-gradient(90deg, #4b6cb7 0%, #182848 100%); padding: 40px 20px; text-align: center; }
        .content { padding: 40px 30px;border-left: 5px solid #3B82F6; border-right: 5px solid #3B82F6; }
        .pied { background: linear-gradient(90deg, #4b6cb7 0%, #182848 100%); padding: 30px 20px; text-align: center; }
        ...
        .copyrights { color: #ffffff; font-size: 12px; margin: 20px 0 0 0; opacity: 0.8; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="pied">
            ...
            <p class="copyrights">&copy; $currentYear Le Média Voironnais. Tous droits réservés.</p>
        </div>
    </div>
</body>
</html>
