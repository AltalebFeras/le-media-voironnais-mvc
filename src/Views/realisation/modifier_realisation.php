...
<main>
    <div class="flex-row justify-content-between">
        <h1><?= $title ?? 'Modifier la réalisation' ?></h1>

        <a href="<?= HOME_URL . 'entreprise/mes_realisations?action=voir&entreprise_uiid=' . $entreprise->getUiid() . '&realisation_uiid=' . $realisation->getUiid() ?>" class="">
    ...
    <div class="flex-row">
        <div class="max-width-50">
            ...
            <form method="post" action="<?= HOME_URL . 'realisation/modifier?realisation_uiid=' . $realisation->getUiid() ?>">
                <div class="card">
                    <div>
                        <div>
                    ...
                    <div class="flex-row justify-content-between mt">
                        <a href="<?= HOME_URL . 'entreprise/mes_realisations?action=voir&entreprise_uiid=' . $entreprise->getUiid() . '&realisation_uiid=' . $realisation->getUiid() ?>" class="btn linkNotDecorated">Annuler</a>
