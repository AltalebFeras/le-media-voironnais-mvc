...
<main>
    ...
    <div class="card mb">
        ...
        <p>
            <a href="<?= HOME_URL ?>realisation/voir?realisation_uiid=<?= htmlspecialchars($realisation->getUiid()) ?>" class="link">
    ...
    <div class="card max-width-75">
        <form method="post" action="<?= HOME_URL ?>realisation/modifier?realisation_uiid=<?= htmlspecialchars($realisation->getUiid()) ?>">
            ...
            <div class="flex-row mt">
                <input type="submit" value="Modifier la réalisation" class="btn">
