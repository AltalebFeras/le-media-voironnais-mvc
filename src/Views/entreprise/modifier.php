            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="4"><?= htmlspecialchars($entreprise->getDescription() ?? '') ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            ...
                            <div class="form-text">Une entreprise non publiée ne sera pas visible publiquement</div>
                        </div>
                    </div>
                    ...
                    <?php if ($entreprise->getLogoPath()): ?>
                        <div class="mb-3">
                            ...
                            <div>
                                <img src="<?= $entreprise->getLogoPath() ?>" alt="Logo actuel" class="img-thumbnail mb-2" style="max-height: 100px;">
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($entreprise->getBannerPath()): ?>
                        <div class="mb-3">
                            ...
                            <div>
                                <img src="<?= $entreprise->getBannerPath() ?>" alt="Bannière actuelle" class="img-thumbnail mb-2" style="max-height: 150px;">
                            </div>
                        </div>
                    <?php endif; ?>
