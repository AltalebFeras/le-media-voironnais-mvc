...
<link rel="stylesheet" href="<?= HOME_URL . 'assets/css/evenements/mes_evenements.css' ?>">
            ...
            <?php foreach ($evenements as $evenement): ?>
                <div class="card">
                    ...
                    <div class="event-actions flex-row">
                        <a href="<?= HOME_URL ?>mes_evenements?action=voir&uiid=<?= $evenement['uiid'] ?>" class="btn btn-info linkNotDecorated">
                            Voir
                        </a>
                    </div>
                </div>
